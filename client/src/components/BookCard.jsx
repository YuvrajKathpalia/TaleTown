...
const BookCard = ({ book }) => {
  ...
  return (
    <div
      className="relative w-[16rem] h-[21rem] flex flex-col items-center overflow-hidden bg-white border border-gray-300 shadow-md rounded-lg transition-transform duration-300 ease-in-out cursor-pointer hover:scale-105"
      onClick={handleClick}
    ...
    >
      ...
      <div className="p-4 flex flex-col h-1/3">
        <h3 className="text-lg font-semibold mb-1 truncate transition-colors duration-300 ease-in-out hover:text-purple-500">{book.title}</h3>
